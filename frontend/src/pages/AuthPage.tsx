  ...
  export const AuthPage: React.FC<AuthPageProps> = ({ onNavigate }) => {
    ...
    if (isLogin) {
      ...
      // ✅ Fix 2: Await the async login call
      const success = await login(formData.email, formData.password);  // ← Added 'await'
      ...
      // ✅ Fix 3: Await the async signup call
      const success = await signup(formData.name, formData.email, formData.password);  // ← Added 'await'
